...
//                    $fromUserID = intval($row->uid1);  // int
                    ...
                    echo "<td>";
                    echo "<a href=../createList/showList?listId=$listId&listName=$urlencodeListName>";
                    echo $listName . "</a>" . "  (shared via <a href=../createList/showUserList?userName=$urlencodeReferrerName&userId=$urlencodeUserId>" . $referrerName . "</a>)";
                    echo "</td>";
                    echo "</tr>";
