<html>
    ...
    <body>
        ...
        <form action="referlist/add_referral" method="post" id="listField">
            ...
            <table border='0' cellspacing='0' style='border-collapse: separate' width='400'>
                ...
                <?php
                    ...
                    foreach ($friendList as $row) {
                        ...
                        echo $shade;              
                        $uid2 = intval($row->uid2);  // int
                        
                        echo "<td width = '10%'><input type=checkbox name=uid2[] value=$uid2> </td> <td width='85%'>";
                        echo $uid2;
                        echo "</tr>";
